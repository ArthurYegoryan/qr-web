...
import searcedTransactions from "../test-json/searchedTransactions.json";

const getTransactionsByPage = async (url, params) => {
    if (params.page === 1 && params.searchParams.hasSearchParams) return searcedTransactions[0].data;
    else if (params.page === 1) return transactionsPage1[0].data;
    else if (params.page === 2) return transactionsPage2[0].data;
